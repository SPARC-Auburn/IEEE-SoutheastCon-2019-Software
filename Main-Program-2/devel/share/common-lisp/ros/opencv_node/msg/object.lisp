...
(cl:defmethod cl:initialize-instance :after ((m <object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_node-msg:<object> is deprecated: use opencv_node-msg:object instead.")))

(cl:ensure-generic-function 'x_position-val :lambda-list '(m))
(cl:defmethod x_position-val ((m <object>))
...
(cl:defmethod y_position-val ((m <object>))
...
(cl:defmethod color_index-val ((m <object>))
...
(cl:defmethod object_type-val ((m <object>))
